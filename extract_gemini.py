...
def get_next_conversation_path(data_dir, prefix="gemini_conversation", ext=".json"):
    """
    Scan data_dir for existing gemini_conversation_XXX.json files and
...
def extract_chat(driver, share_url):
    logging.info("Opening shared Gemini URL")
    ...
    data_dir = os.path.join(os.curdir, "gemini_convo_data")
